...
```{r}
##Step 1
vdem <- read.csv("V-Dem-CY-Full+Others-v9.csv")
...
write.csv(vdem, "VDem African Conflict.csv") #Save CSV of VDem-African Conflict

##Step 4
vdem <- read.csv("VDem African Conflict.csv")
...
```{r}
##Step 1
ucdp <- read.csv("UCDP Armed Conflict.csv")
...
##Step 5
write.csv(ucdp, "UCDP African Conflict.csv") #Save CSV

##Step 6
ucdp <- read.csv("UCDP African Conflict.csv") #to read in cleaned dataframe
...
##Step 4
write.csv(epr, "EPR African Conflict.csv") #Save CSV of EPR-Africa

##Step 5
epr <- read.csv("EPR African Conflict.csv") #to read in cleaned dataframe
...
##Step 3
write.csv(wdi, "WDI African Conflict.csv") #Save as CSV

##Step 4
wdi <- read.csv("WDI African Conflict.csv")
...
```{r}
ross <- read.csv("Ross-Mahdavi Oil and Gas 1932-2014.csv")
...
#write CSV
write.csv(afcon, "African Conflict Database.csv")

#read CSV
afcon <- read.csv("African Conflict Database.csv")
...
```{r}
#Simple Model
m2s <- polr(as.factor(severity) ~ regime_type + regime_changed + resource_inequality + power_inequality + clientelism + presidentialism + coup + male1529 + year, Hess = TRUE) #had to exclude population
summary(m2s)

#Complex model
#Continuous regime type
m2c <- polr(as.factor(severity) ~ regime_type + regime_changed + I(resource_inequality^2) + power_inequality + clientelism + presidentialism + coup + male1529 + year, Hess = TRUE)
summary(m2c)
coeftest(m2c)

#Factor Regime Type
m2f <- polr(as.factor(severity) ~ regime_type_factor + regime_changed + I(resource_inequality^2) + power_inequality + clientelism + presidentialism + coup + male1529 + year, Hess = TRUE)
summary(m2f)
coeftest(m2f)
...
#PCE Model
m2PCE <- polr(as.factor(severity) ~ regime_type + regime_changed + I(resource_inequality^2) + power_inequality + clientelism + presidentialism + coup + male1529 + year + PCE, Hess = TRUE)
summary(m2PCE)
coeftest(m2PCE)

#GDP Model
m2gdp <- polr(as.factor(severity) ~ regime_type + regime_changed + I(resource_inequality^2) + power_inequality + clientelism + presidentialism + coup + male1529 + year + gdp_growth + gdp_percap, Hess = TRUE)
summary(m2gdp)
coeftest(m2gdp)
...
```{r}
#Simple Model
m4s <- polr(as.factor(relapse) ~ regime_type + regime_changed + resource_inequality + power_inequality + clientelism + presidentialism + coup + male1529 + year, Hess=TRUE) #remove population
summary(m4s)

#Complex Model
#Continuous Regime Type
m4c <- polr(as.factor(relapse) ~ regime_type + regime_changed + I(resource_inequality^2) + power_inequality + clientelism + presidentialism + coup + male1529 + year, Hess=TRUE)
summary(m4c)
coeftest(m4c)

#Factor Regime Type
m4f <- polr(as.factor(relapse) ~ regime_type_factor + regime_changed + I(resource_inequality^2) + power_inequality + clientelism + presidentialism + coup + male1529 + year, Hess=TRUE)
summary(m4f)
coeftest(m4f)

#PCE Model
m4pce <- polr(as.factor(relapse) ~ regime_type + regime_changed + I(resource_inequality^2) + power_inequality + clientelism + presidentialism + coup + male1529 + year + PCE, Hess=TRUE)
summary(m4pce)
coeftest(m4pce)
...
#Full Model
m4full <- polr(as.factor(relapse) ~ regime_type + regime_changed + resource_inequality + power_inequality + clientelism + presidentialism + coup + + male1529 + year + PCE + gdp_growth + gdp_percap, Hess=TRUE)
summary(m4full)
coeftest(m4full)
